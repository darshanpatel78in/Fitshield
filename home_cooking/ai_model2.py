...
def calculate_nutrients(ingredient_name, quantity_g, retriever):
    try:
        ...
        # Fetch nutrient data from the database
...
#      #******************************pooja********************************#
                ...
                print(f"checkkkkkkkkkkkkkkkkkkkkkkkkkk: {output_ingredients}")
                # Prepare model2 data
                model2_data = {
                ...
                print("here we are in normal half")
             ...
             #**********************pooja******************************#                 
                ...
                ingredient_distributed_nutrients = distribute_nutrients(total_nutrients)
                logging.info(f"Distributed nutrients across ingredients: {ingredient_distributed_nutrients}")
                print("ingredients getting empty")
                print(f"checkkkkkkkkkkkkkkkkkkkkkkkkkk: {output_ingredients}")
                # Prepare model2 data
                model2_data = {
                    "ingredients": output_ingredients,
            ...
            if variant == "full":
                print("here we are in jain full")
                ...
                print("here we are in jain half")
